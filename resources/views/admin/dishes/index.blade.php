...
@section('content')
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="{{ route('admin.dishes.create') }}"
            class="bg-[#F5A623] text-white px-4 py-2 rounded hover:bg-[#F5A623]/90 flex items-center gap-2">
            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr class="border-b border-gray-200">
                        ...
                        <th class="text-left py-3 px-4 text-sm font-semibold text-gray-700">Foto</th>
                ...
                <tbody>
                    @foreach($dishes as $dish)
                        <tr class="border-b border-gray-100">
                            ...
                            <td class="py-4 px-4">
                                <span
                                    class="inline-flex px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-700">{{ $dish->category }}</span>
                            </td>
